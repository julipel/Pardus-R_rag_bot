...
def demo_mode(rag_assistant: RAGAssistant, cache: ResponseCache, logger: DatabaseLogger):
    ...
    demo_questions = [
        'Что такое рентгеновский аппарат "Пардус-Р" и для чего он используется?',
        "Расскажи про комплектацию аппарата и как он работает",
        'Как рассчитать безопасный режим работы с аппаратом "Пардус-Р"?',
        'Какие технические параметры аппарата "Пардус-Р"?'  # Повторный вопрос для демонстрации кеша
    ]
